...
def demonstrate_secure_communication(message):
...
def main():
    """Main function to handle user input and run the demonstration."""
    print("Quantum-Secured Messaging System")
    print("================================")
    print("This program demonstrates secure communication using quantum key distribution")
    print("and post-quantum cryptography techniques.")
    print("\nPlease enter a message to encrypt and send:")
    
    user_message = input("> ")
    
    if not user_message.strip():
        print("Empty message detected. Using default message instead.")
        user_message = "This is a top-secret message protected by quantum and post-quantum cryptography!"
    
    demonstrate_secure_communication(user_message)
